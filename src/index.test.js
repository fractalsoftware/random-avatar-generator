...
describe('Get svg from avatar data', () => {
  ...
  it('should return a svg rendered with circles for a given code', () => {
    expect(getAvatarFromData('1-2-4orq2-yhy8', 256, 'circle'))
  ...
  it('should return a svg rendered with a custom method', () => {
    ...
    expect(getAvatarFromData('1-2-4orq2-yhy8', 256, renderTriangles))
...
describe('Get a random svg avatar', () => {
  it('should return a random svg', () => {
    ...
    expect(getRandomAvatar(2, 16)).toMatch(/<svg xmlns="http:\/\/www.w3.org\/2000\/svg" width="100%" height="100%" viewBox="0 0 16 16">.+<\/svg>/);
  });
});